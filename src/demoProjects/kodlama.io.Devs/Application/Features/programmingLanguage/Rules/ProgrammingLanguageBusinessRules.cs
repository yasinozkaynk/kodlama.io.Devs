...
namespace Application.Features.programmingLanguage.Rules
{
    public class ProgrammingLanguageBusinessRules
    {
        ...
        public void ProgramminglanguageNotAvailable(ProgrammingLanguage programmingLanguage)
        {
            if (programmingLanguage==null) throw new BusinessException("Programming language not available");
        }
